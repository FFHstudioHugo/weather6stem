...
//diskRadius *= 0.0175;
	...
	float softness = clamp(NGSS_GLOBAL_SOFTNESS_OPTIMIZED, 0.001, 0.25) * 0.065 / _ShadowMapTexture_TexelSize.w;
	...
	return lerp(_LightShadowData.r, 1.0, shadow / iterations);
