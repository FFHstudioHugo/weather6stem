...
public class Immersive_Path
{
    ...
    public Immersive_Path(Vector3 center)
    {
    ...
    {
        anchorPos.z = points[points.Count - 1].z;
        points.Add(points[points.Count - 1] * 2 - points[points.Count - 2]);
    ...
    public Vector3[] CalculateEvenlySpacePoints(float spacing, float resolution = 1)
    {
        ...
        for (int segmentIndex = 0; segmentIndex < NumSegments; segmentIndex++)
        {
            ...
            {
                t += 1f/divisions;
                Vector3 pointOnCurve = Immersive_Bezier.EvaluateCubic(p[0], p[1], p[2], p[3], t);
