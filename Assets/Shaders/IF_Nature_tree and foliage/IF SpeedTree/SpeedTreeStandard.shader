...
Shader "Immersive Factory/Nature/SpeedTreeStandard"
{
	Properties
	{
		_Color ("Main Color", Color) = (1,1,1,1)
		_SpecCol ("Metallic Color", Color) = (0,0,0,0)
		...
		_AOVert ("Vertex AO intensity", Float) = 1.0
	...
	SubShader
	{
		...
		CGPROGRAM
			#pragma surface surf Standard vertex:SpeedTreeVert nolightmap
			#pragma target 3.0
			...
			#define ENABLE_WIND
			#include "SpeedTreeCommonBrdf.cginc"
