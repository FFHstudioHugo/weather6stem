...
Shader "Immersive Factory/Nature/Tree Branch"
{
	Properties
	{
		...
		_Maincolor("Maincolor", Color) = (0.4622642,0.4622642,0.4622642,0)
		_TextureSample0("Texture Sample 0", 2D) = "white" {}
		[HDR]_SnowColor("SnowColor", Color) = (0.7264151,0.7264151,0.7264151,0)
	...
	SubShader
	{
		Tags{ "RenderType" = "TreeOpaque"  "Queue" = "AlphaTest+0" "IgnoreProjector" = "True" "IsEmissive" = "true"  }
		LOD 3
		Cull Off
		ZWrite Off
		CGPROGRAM
		...
		#pragma surface surf StandardSpecular keepalpha addshadow fullforwardshadows exclude_path:deferred nodirlightmap dithercrossfade vertex:vertexDataFunc 
		struct Input
		{
			float3 worldPos;
			float2 uv_texcoord;
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 break282 = ( ( (float3( 0,0,0 ) + (sin( ( ( temp_output_60_0 * ( _TrunkWindSpeed / ase_objectScale ) ) * appendResult250 ) ) - ( float3(-1,-1,-1) + _TrunkWindSwinging )) * (_Vector2 - float3( 0,0,0 )) / (_Vector2 - ( float3(-1,-1,-1) + _TrunkWindSwinging ))) * _TrunkWindWeight ) * lerp(lerp(v.color.a,v.color.b,_UseLegacyVertexColors),( v.texcoord1.xy.y * 0.01 ),_UseSpeedTreeWind) );
			...
			#endif //aselc
			o.vertexToFrag332 = ( ( ( (0.0 + (dotResult36 - -1.0) * (1.0 - 0.0) / (1.0 - -1.0)) * lerp(v.color.b,v.color.a,_UseLegacyVertexColors) ) * _TransmissionColor.a ) * ( _TransmissionColor * ase_lightColor ) );
		}

		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			float3 ase_worldPos = i.worldPos;
			float temp_output_9_0_g1 = 0.2;
			float2 appendResult7_g1 = (float2((0.5 + (( ase_worldPos.x * temp_output_9_0_g1 ) - 0.0) * (1.0 - 0.5) / (1.0 - 0.0)) , (0.5 + (( ase_worldPos.z * temp_output_9_0_g1 ) - 0.0) * (1.0 - 0.5) / (1.0 - 0.0))));
			float2 uv_BumpMap62 = i.uv_texcoord;
			float2 uv_TexCoord349 = i.uv_texcoord * float2( 2,2 );
			float4 tex2DNode336 = tex2D( _TextureSample0, uv_TexCoord349 );
			float normalizeResult345 = normalize( tex2DNode336.r );
			float temp_output_338_0 = ( normalizeResult345 * ( _GlobalSnowness * tex2DNode336.r ) );
			float clampResult347 = clamp( ( ( temp_output_338_0 * 1000.0 * temp_output_338_0 ) + ( _GlobalSnowness * 0.7 ) ) , 0.0 , 1.0 );
			float temp_output_350_0 = ( 1.0 - clampResult347 );
			float3 lerpResult341 = lerp( UnpackNormal( tex2D( _SnowNormal, appendResult7_g1 ) ) , UnpackNormal( tex2D( _BumpMap, uv_BumpMap62 ) ) , temp_output_350_0);
			o.Normal = lerpResult341;
			float4 SSS45 = i.vertexToFrag332;
			float2 uv_MainTex19 = i.uv_texcoord;
			float4 tex2DNode19 = tex2D( _MainTex, uv_MainTex19 );
			float4 lerpResult246 = lerp( ( tex2DNode19 * _GradientBrightness ) , tex2DNode19 , i.vertexColor.b);
			...
			float4 lerpResult337 = lerp( _SnowColor , ( _Maincolor * ( SSS45 + lerpResult97 ) ) , temp_output_350_0);
...
/*ASEBEGIN
Version=15600
481;75;952;872;-1116.403;568.5914;1.844263;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;59;-3922.506,-1624.636;Float;False;Global;_WindSpeed;_WindSpeed;7;0;Create;True;0;0;False;0;0.3;0.051;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;239;-3957.72,-1217.98;Float;False;2848.898;709.3215;Comment;23;283;282;118;143;152;206;144;170;150;242;154;148;171;250;141;194;87;142;168;316;320;321;322;Global wind animation;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;142;-3907.72,-909.7822;Float;False;Global;_TrunkWindSpeed;_TrunkWindSpeed;10;0;Create;True;0;0;False;0;10;62.3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;85;-3626.292,489.3988;Float;False;2725.568;616.9805;Subsurface;18;45;226;225;215;213;224;214;317;229;36;232;40;231;236;330;33;34;332;Transmission;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.Vector4Node;87;-3927.026,-1131.687;Float;False;Global;_WindDirection;_WindDirection;9;0;Create;True;0;0;False;0;1,0,0,0;0,0,-1,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ObjectToWorldTransfNode;204;-3057.428,133.5205;Float;False;1;0;FLOAT4;0,0,0,1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;23;-2841.293,152.8998;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;171;-3197.828,-798.7911;Float;False;Global;_TrunkWindSwinging;_TrunkWindSwinging;10;0;Create;True;0;0;False;0;0;0.135;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;211;-3322.042,-2039.813;Float;False;Property;_WindAmplitudeMultiplier;WindAmplitudeMultiplier;9;0;Create;True;0;0;False;0;1;3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;248;-2930.195,-149.8801;Float;False;Property;_GradientBrightness;GradientBrightness;10;0;Create;True;0;0;False;0;1;0.13;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;24;-2653.295,185.6992;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;19;-3047.296,-359.2004;Float;True;Property;_MainTex;MainTex;0;1;[NoScaleOffset];Create;True;0;0;False;0;None;91b7d33d33303964eb0dbf5f2edc9aa8;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;0;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;349;305.3456,697.3472;Float;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;2,2;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;83;-2473.749,-110.3892;Float;False;Property;_HueVariation;Hue Variation;1;0;Create;True;0;0;False;0;1,0.5,0,0.184;1,0.5,0,0.09803922;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ToggleSwitchNode;317;-2681.895,913.4861;Float;False;Property;_UseLegacyVertexColors;UseLegacyVertexColors;12;0;Create;True;0;0;False;0;0;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FractNode;203;-2489.529,186.6203;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SinOpNode;150;-2880.324,-1106.686;Float;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;247;-2533.993,-368.9799;Float;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;144;-2294.521,-923.9849;Float;False;Global;_TrunkWindWeight;_TrunkWindWeight;10;0;Create;True;0;0;False;0;2;0.27;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;339;624.6484,1084.126;Float;False;Global;_GlobalSnowness;_GlobalSnowness;18;0;Create;True;0;0;False;0;0;0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;336;641.1299,610.2546;Float;True;Property;_TextureSample0;Texture Sample 0;15;0;Create;True;0;0;False;0;None;4925ee9198b00c8498b9d1e91b2c4b59;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ToggleSwitchNode;316;-2253.856,-796.6009;Float;False;Property;_UseLegacyVertexColors;UseLegacyVertexColors;12;0;Create;True;0;0;False;0;0;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;213;-2398.831,721.1215;Float;False;Property;_TransmissionColor;Transmission Color;4;0;Create;True;0;0;False;0;1,1,1,0;0.1809804,0.462264,0.1922318,0.4392157;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.NormalizeNode;345;935.8508,604.878;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;344;1043.796,810.1857;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0.81;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;322;-1915.224,-706.8527;Float;False;Property;_UseSpeedTreeWind;UseSpeedTreeWind;13;0;Create;True;0;0;False;0;0;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;354;1073.638,1123.471;Float;False;Constant;_Float2;Float 2;20;0;Create;True;0;0;False;0;0.7;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;338;1110.994,597.8954;Float;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;319;-2061.475,-1614.09;Float;False;Property;_UseSpeedTreeWind;UseSpeedTreeWind;13;0;Create;True;0;0;False;0;0;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;98;284.0998,-712.3729;Float;False;99;WindVectors;0;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;56;-1473.894,-112.0015;Float;False;Color;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.WireNode;273;-109.7907,-588.0359;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;57;307.7924,-795.8511;Float;False;56;Color;0;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;348;1333.414,614.5906;Float;False;3;3;0;FLOAT;0;False;1;FLOAT;1000;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;16;-1766.407,-1659.435;Float;False;Property;_MaxWindStrength;MaxWindStrength;6;0;Create;True;0;0;False;0;0.1164738;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;284;-1764.627,-1563.295;Float;False;Global;_WindStrength;_WindStrength;12;0;Create;True;0;0;False;0;1;0.5832;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.VertexToFragmentNode;332;-1423.559,585.8492;Float;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;353;1361.253,950.9014;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;97;663.5539,-578.9302;Float;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;50;-2409.993,1253.799;Float;False;Property;_AmbientOcclusion;AmbientOcclusion;5;0;Create;True;0;0;False;0;0;0.174;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;352;1496.844,749.5712;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;333;1071.504,-536.8214;Float;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ClampOpNode;347;1676.455,537.7654;Float;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;334;988.7472,-731.3494;Float;False;Property;_Maincolor;Maincolor;14;0;Create;True;0;0;False;0;0.4622642,0.4622642,0.4622642,0;0.6792453,0.6440014,0.6440014,0;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;343;363.3976,969.7489;Float;False;WorldPos;-1;;1;739ed574e5a46e2438e5d1b0fa07ab88;0;1;9;FLOAT;0.2;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;254;-89.41714,-236.6956;Float;False;Property;_Smoothness;Smoothness;11;0;Create;True;0;0;False;0;0;0.025;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;95;208.6328,558.2144;Float;False;Property;_FlatLighting;FlatLighting;7;0;Create;True;0;0;False;0;0;0.036;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;335;1272.341,-548.2799;Float;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;32;-328.496,-44.40088;Float;False;31;Alpha;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;340;1022.523,311.3091;Float;False;Property;_SnowColor;SnowColor;16;1;[HDR];Create;True;0;0;False;0;0.7264151,0.7264151,0.7264151,0;0.7264151,0.7264151,0.7264151,0;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;342;1398.781,1104.621;Float;True;Property;_SnowNormal;SnowNormal;17;0;Create;True;0;0;False;0;None;c6e484574ffae05409d80dcc43b98b4e;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VertexToFragmentNode;331;-654.8947,-1397.448;Float;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.OneMinusNode;350;1941.064,712.0575;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;217;-54.78961,-161.1802;Float;False;218;AmbientOcclusion;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;18;624.2745,22.64254;Float;False;17;Wind;0;1;FLOAT3;0
Node;AmplifyShaderEditor.LerpOp;101;2076.254,-9.58211;Float;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;355;2155.322,-145.6567;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;46;7.430328,-312.6622;Float;False;45;SSS;0;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;337;1789.299,106.8235;Float;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;341;2136.257,890.558;Float;True;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;2612.509,-261.1337;Float;False;True;2;Float;ASEMaterialInspector;3;0;StandardSpecular;Immersive Factory/Nature/Tree Branch;False;False;False;False;False;False;False;False;True;False;False;False;True;False;True;False;True;False;False;False;Off;2;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;0.5;True;True;0;True;TreeOpaque;;AlphaTest;ForwardOnly;True;True;True;True;True;True;True;False;True;True;False;False;False;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;0;20.3;10;25;True;0.5;True;0;5;False;-1;10;False;-1;0;5;False;-1;10;False;-1;1;False;-1;1;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;3;Nature/SpeedTree;2;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;3;Include;VS_InstancedIndirect.cginc;Pragma;instancing_options assumeuniformscaling lodfade maxcount:50 procedural:setup;Pragma;multi_compile GPU_FRUSTUM_ON __;0;0;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;317;0;40;3
WireConnection;317;1;40;4
...
WireConnection;336;1;349;0
WireConnection;316;0;206;4
WireConnection;316;1;206;3
...
WireConnection;345;0;336;1
WireConnection;344;0;339;0
WireConnection;344;1;336;1
...
WireConnection;333;0;45;0
WireConnection;333;1;97;0
...
ASEEND*/
//CHKSM=69F14F32A3B502C41B19CCA46FA09C4F6F321A92